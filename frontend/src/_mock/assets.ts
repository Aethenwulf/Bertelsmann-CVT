...
export const _stateCode = [
  ...
  { label: "BELARUS: BY (Treaty Suspended)", value: "BY" },
  ...
  { label: "BRITISH VIRGIN ISLANDS: VG", value: "VG" },
  ...
  { label: "FALKLAND ISLANDS: FK", value: "FK" },
  ...
  { label: "GEORGIA (REPUBLIC OF): GE", value: "GE" },
  ...
  { label: "HUNGARY: HU (Treaty Terminated)", value: "HU" },
  ...
  { label: "PALESTINIAN TERRITORIES: PS", value: "PS" },
  ...
  { label: "RUSSIA: RU (Treaty Suspended)", value: "RU" },
  ...
  { label: "ST. VINCENT AND THE GRENADINES: VC", value: "VC" },
  ...
  { label: "U.S. VIRGIN ISLANDS: VI", value: "VI" },
